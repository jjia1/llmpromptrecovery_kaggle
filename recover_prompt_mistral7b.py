...
for json_file in os.listdir(path):
    if json_file.endswith("training_data*.json"):
...
test_data_df.to_json('/home/matthewn/kaggle/llm_prompt_recovery/test_data.json', orient='records', lines=True)
train_data_df.to_json('/home/matthewn/kaggle/llm_prompt_recovery/train_data.json', orient='records', lines=True)
